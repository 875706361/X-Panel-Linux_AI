...
[![](https://img.shields.io/github/v/release/875706361/X-Panel-Linux.svg?style=for-the-badge)](https://github.com/875706361/X-Panel-Linux/releases)
[![](https://img.shields.io/github/actions/workflow/status/875706361/X-Panel-Linux/release.yml.svg?style=for-the-badge)](https://github.com/875706361/X-Panel-Linux/actions)
[![GO Version](https://img.shields.io/github/go-mod/go-version/875706361/X-Panel-Linux.svg?style=for-the-badge)](#)
[![Downloads](https://img.shields.io/github/downloads/875706361/X-Panel-Linux/total.svg?style=for-the-badge)](https://github.com/875706361/X-Panel-Linux/releases/latest)
...
## [【X-Panel面板】交流群：]()
## [【X-Panel面板】详细安装流程步骤](https://github.com/875706361/X-Panel-Linux)
...
```
bash <(curl -Ls https://raw.githubusercontent.com/875706361/X-Panel-Linux/main/install.sh)
```
...
- 【全新安装】请执行以下脚本（私有仓库需提前设置 GITHUB_TOKEN）：
```bash
export GITHUB_TOKEN=xxxxxxxxxx
bash <(curl -Ls -H "Authorization: token $GITHUB_TOKEN" -H "Accept: application/vnd.github.v3.raw" https://api.github.com/repos/875706361/X-Panel-Linux/contents/install.sh)
```
...
若要安装指定的版本，请使用以下安装命令（需设置 GITHUB_TOKEN）。 e.g., ver `v26.1.8`:
```bash
export GITHUB_TOKEN=xxxxxxxxxx
VERSION=v26.1.8 && bash <(curl -Ls -H "Authorization: token $GITHUB_TOKEN" -H "Accept: application/vnd.github.v3.raw" "https://api.github.com/repos/875706361/X-Panel-Linux/contents/install.sh") $VERSION
```
------------
...
wget https://github.com/875706361/X-Panel-Linux/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. **克隆项目仓库**
   ...
   ```sh
   git clone https://github.com/875706361/X-Panel-Linux.git
   cd x-panel
   ```
...
3. **启动服务**：
   ...
   **或**
   ...
   docker run -itd \
      ...
      --name x-panel \
      ghcr.io/875706361/X-Panel-Linux:latest
   ```
...
- [MHSanaei](https://github.com/875706361/X-Panel-Linux/)
- [alireza0](https://github.com/alireza0/)
- [FranzKafkaYu](https://github.com/FranzKafkaYu/)
- [vaxilu](https://github.com/875706361/X-Panel-Linux/)
...
[![Stargazers over time](https://starchart.cc/875706361/X-Panel-Linux.svg)](https://starchart.cc/875706361/X-Panel-Linux)
